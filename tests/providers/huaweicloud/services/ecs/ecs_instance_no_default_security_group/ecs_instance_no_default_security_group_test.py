...
class TestEcsInstanceNoDefaultSecurityGroup:
    def test_instance_without_default_sg_passes(self):
        ...
        with (
            ...
            instance = Instance(
                ...
                region="la-south-2",
                status="ACTIVE",
                security_groups={"sg-001": "custom-sg"},
            )
            ...
            assert "does not use the default security group" in result[0].status_extended
